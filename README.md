...
| 🍕 [Pizzaria](https://github.com/CaioSNery/PizzariaAPI) <br> ![.NET](https://img.shields.io/badge/.NET-8.0-blue) | Primeira API de estudo, com lógica simples de pedidos e sabores. | ASP.NET Core, EF Core |
