...
|--------|-------------|------|
| ☕ [Coffee Recommender – **GenAI**](https://github.com/CaioSNery/CoffeeRecommender) | Coffee recommendation system based on semantic similarity. Uses embeddings to analyze product characteristics stored in the database and generate intelligent suggestions. | .NET, Semantic Kernel, Embeddings, RAG, Vector Database |
